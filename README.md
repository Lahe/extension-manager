...
![Design preview for the Browser extensions manager UI coding challenge](documentation/preview.jpg)
...
We strongly recommend overwriting this `README.md` with a custom one. We've provided a template inside the [`README-template.md`](documentation/README-template.md) file in this starter code.
